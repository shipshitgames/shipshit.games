...
type SectionId = "maps" | "sprites" | "music" | "3d" | "moodboard" | "research" | "codegen";
type Group = "Generators" | "Art Direction" | "Research" | "Codegen";
...
const GROUPS: Group[] = ["Generators", "Art Direction", "Research", "Codegen"];
      ...
      <div className="workspace">
        ...
        <main className="pane">
          ...
          <div className="pane-body">
            {active === "sprites" ? <SpritesPane /> : active === "music" ? <MusicPane /> : active === "moodboard" ? <MoodboardPane /> : active === "research" ? <ResearchPane /> : (
